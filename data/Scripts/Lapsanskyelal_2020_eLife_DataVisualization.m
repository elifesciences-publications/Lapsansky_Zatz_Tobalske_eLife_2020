...
e(1,1).geom_jitter()
e(1,1).set_names('x','Aerial flight','y','Stroke-plane angle (deg)')
...
e(1,2).geom_point()
e(1,2).set_names('x','Aquatic flight descent angle (deg)','y','Stroke-plane angle (deg)')
...
c(1,1).set_names('x','Descent angle (deg)','y','Chord angle (deg)')
